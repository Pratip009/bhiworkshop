...
const Profile = () => {
  ...
  const renderProfileTab = () => (
    <div className="bg-white p-8 rounded-xl shadow-xl max-w-lg mx-auto text-black">
      <div className="flex items-center mb-6">
        <div className="w-16 h-16 rounded-full bg-blue-500 flex items-center justify-center text-2xl font-bold uppercase">
          {user?.username?.[0] || "U"}
        </div>
        <div className="ml-4">
  ...
  const renderWorkshopsTab = () => (
    <div>
              ...
              <div className="p-5">
                ...
                {entry.course?.description ? (
                  <p className="text-gray-400 text-sm mb-3 leading-relaxed">
                    {entry.course.description.length > 100
                      ? entry.course.description.slice(0, 100) + "..."
                      : entry.course.description}
                  </p>
                ) : (
      ...
      {/* Later: Map through purchased workshops here */}
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-white text-black flex">
      {/* Sidebar Tabs */}
      <div className="w-64 bg-gray-300 p-6 border-r border-gray-200">
